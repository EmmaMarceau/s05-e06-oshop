...
<head>
    ...
    <link rel="stylesheet" href="<?= getAbsoluteURL('assets/css/bootstrap.min.css'); ?>">
    <link rel="stylesheet" href="<?= getAbsoluteURL('assets/css/font-awesome.min.css'); ?>">
    <link rel="stylesheet" href="<?= getAbsoluteURL('assets/css/owl.carousel.min.css'); ?>">
    <link rel="stylesheet" href="<?= getAbsoluteURL('assets/css/owl.theme.default.min.css'); ?>">
    <link rel="stylesheet" href="<?= getAbsoluteURL('assets/css/styles.css'); ?>">
    <title>oShop</title>
</head>
