                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
                            <li class="list-inline-item">
                                <img src="<?= getAbsoluteURL('assets/images/visa.svg'); ?>" alt="..." class="payment-icon">
                            </li>
                            <li class="list-inline-item">
                                <img src="<?= getAbsoluteURL('assets/images/mastercard.svg'); ?>" alt="..." class="payment-icon">
                            </li>
                            <li class="list-inline-item">
                                <img src="<?= getAbsoluteURL('assets/images/paypal.svg'); ?>" alt="..." class="payment-icon">
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- JS -->
    <script src="<?= getAbsoluteURL('assets/js/jquery.min.js'); ?>"></script>
    <script src="<?= getAbsoluteURL('assets/js/popper.min.js'); ?>"></script>
    <script src="<?= getAbsoluteURL('assets/js/bootstrap.min.js'); ?>"></script>
    <script src="<?= getAbsoluteURL('assets/js/owl.carousel.min.js'); ?>"></script>
    <script src="<?= getAbsoluteURL('assets/js/app.js'); ?>"></script>
</body>
